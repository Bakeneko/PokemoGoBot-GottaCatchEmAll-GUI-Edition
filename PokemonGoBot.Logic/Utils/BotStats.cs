...
namespace PokemonGoBot.Logic.Utils
{
    public class BotStats
    {
        ...
        {
            return _playerName = Logic._client.Settings.AuthType == AuthType.Ptc ? Logic._client.Settings.UserNameOrEmail : profile.PlayerData.Username;
        }
